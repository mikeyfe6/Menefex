      ...
      <div className="container privacypol">
        <div className="col-lg-9">
          ...
          <p>
            ...
            publicitaire doeleinden, dan wel voor enige commerciële aanbiedingen
          ...
          <br />
          <h5>Artikel 4 - Het beheer van de website</h5>
          <br />
          <p>
          ...
          <ul>
            <li>
              ...
              onderbreken of beperken tot de gehele of een gedeelte van de
              website
            </li>
            <li>
          ...
          <br />
          <h5>Artikel 5 - Verantwoordelijkheden</h5>
          <br />
          <p>
          ...
          <p>
            ...
            geïdentificeerd, met name aan de hand van een identificator zoals
            een naam, een identificatienummer, locatiegegevens, een online
            identificator of een of meer elementen die kenmerkend zijn voor de
            fysieke, fysiologische, genetische, psychische, economische,
          ...
          <p>
            ...
            contact met ons op te nemen via michaelfransman@gimmix.nl. 
          </p>
          <p>
          ...
          <ol>
            <li>
              Een cookie is een klein tekstbestand dat bij bezoek aan onze
              website geplaatst wordt op de harde schijf van uw computer. Een
              cookie bevat gegevens zodat u bij elk bezoek aan onze website als
              bezoeker kan worden herkend. Het is dan mogelijk om onze
              website speciaal op u in te stellen en het inloggen te
              vergemakkelijken. Wanneer u onze website bezoekt, verschijnt er
              een banner waarmee we u informeren over het gebruik van cookies.
              Bij verder gebruik van onze website accepteert u het gebruik
              ervan. Uw toestemming is geldig voor een periode van dertien
              maanden.
            </li>
            <li>
              Wij gebruiken de volgende soorten cookies op onze website: <br />
              <b>- Functionele cookies:</b> zoals sessie- en login cookies voor
              het bijhouden van sessie- en inloginformatie.
              <br />
              <b>- Geanonimiseerde Analytische cookies:</b> om inzage te krijgen
              in het bezoek aan onze website op basis van informatie over
              bezoekersaantallen, populaire pagina’s en onderwerpen. Op deze
              wijze kunnen we de communicatie en informatievoorziening beter
              afstemmen op de behoeften van bezoekers van onze website. We
              kunnen niet zien wie onze websites bezoekt of vanaf welke pc het
              bezoek plaatsvindt.
              <br />
            </li>
            ...
            <li>
              Voor meer informatie over het gebruik, het beheer en het
              verwijderen van cookies voor elk besturingstype, nodigen wij u uit
              om de volgende link te raadplegen:{' '}
              <a
