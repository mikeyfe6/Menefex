  ...
  return (
    <Layout>
      <SEO
        ...
        keywords="work, website, app, projecten, eternity, black harmony, wordpress, react, gatsby, freelance, elementor, github, portfolio"
        pathname="/work/"
      />
            ...
            <div className="item">
              ...
              <div className={workDesign.projectInfo}>
                <p className={workDesign.projectText}>
                  ...
                  <br />
                  <b>
                    * Deze website bevat informatie, media en interactieve
